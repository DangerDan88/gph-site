...
const aboutPage = ({ data }) => (
  <Layout>
    ...
    <div className="bg-gray-700 flex justify-center py-4 text-2xl text-white rounded-lg">
      ...
      11-17 in Boston as a sponsored rider for Groton House Farms. She was able
      to bring numerous horses up the levels and make trips to England for
      training with Danny Anholt. She trained with a number of other top notch
      eventers and jumpers including Eric Smiley, Jennifer Berryman, and Bobby
      Costello. She moved to Boston after high school to continue riding and
      eventually ended up managing and training out of a high end Foxhunting
      barn before moving back to Utah a few years ago. GPH operates out of Cazca
      Ranch in Riverton, Utah. The beautiful facility features indoor and
      outdoor riding arenas, roomy stalls for happy horses, and multiple turnout
      spaces.
    </div>
