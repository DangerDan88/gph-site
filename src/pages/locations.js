    ...
    <div className="bg-gray-700">
      <div className="max-w-3xl bg-gray-700 text-white text-2xl rounded-lg mx-auto my-16">
        <div className="flex justify-center py-4 bg-black">
          <div className="m-2 text-justify text-2xl font-bold">Fox Stables</div>
        </div>
        <div className="flex justify-center bg-black">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-green-900 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-900 rounded"
          >
            Directions
          </a>
        </div>
